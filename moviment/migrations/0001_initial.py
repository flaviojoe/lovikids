    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(max_length=150, null=True, verbose_name='descrição')),
                ('percent_done', models.FloatField(verbose_name='realizado')),
                ...
                ('job_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.job')),
